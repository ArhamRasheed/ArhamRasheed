...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-%230077B5.svg?logo=linkedin&logoColor=white)](https://www.linkedin.com/in/arhamrasheed20)
...
|--------|-------|-------------|
| [HR Management System](https://github.com/ArhamRasheed/HR-management-Backend) | Django · MySQL · DRF | Full-stack HRMS with JWT auth and REST API |
| [Tutors Pool](https://github.com/ArhamRasheed/tutors-pool-bright) | React · TypeScript · React Query | Multi-role platform connecting students and tutors |
| [Pomotrix](https://github.com/ArhamRasheed/Pomotrix) | TypeScript | Pomodoro-based productivity timer app |
